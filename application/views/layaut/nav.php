<div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="<?=base_url('evento')?>" class="d-block text-light p-3 border-0"><i class="icon ion-md-copy lead mr-2"></i>
                    Crear evento</a>
...
<a class="btn btn-primary" href="<?=base_url('index.php/login/logout')?>" role="button">cerrar session</a>   
 </nav>
 <!-- Fin Navbar -->